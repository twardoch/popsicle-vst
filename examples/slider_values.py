...
class MainContentComponent(juce.Component):
    ...
    def __init__(self):
        ...
        self.frequencySlider.onValueChange = lambda: self.durationSlider.setValue(
            1.0 / self.frequencySlider.getValue(), juce.dontSendNotification
        )
        ...
        self.durationSlider.setRange(
            1.0 / self.frequencySlider.getMaximum(),
            1.0 / self.frequencySlider.getMinimum(),
        )
        self.durationSlider.setTextValueSuffix(" s")
        self.durationSlider.onValueChange = lambda: self.frequencySlider.setValue(
            1.0 / self.durationSlider.getValue(), juce.dontSendNotification
        )
        ...
        self.frequencySlider.setTextBoxStyle(
            juce.Slider.TextBoxLeft, False, 160, self.frequencySlider.getTextBoxHeight()
        )
        self.durationSlider.setTextBoxStyle(
            juce.Slider.TextBoxLeft, False, 160, self.durationSlider.getTextBoxHeight()
        )
    ...
    def resized(self):
        sliderLeft = 120
        self.frequencySlider.setBounds(
            sliderLeft, 20, self.getWidth() - sliderLeft - 10, 20
        )
        self.durationSlider.setBounds(
            sliderLeft, 50, self.getWidth() - sliderLeft - 10, 20
        )
